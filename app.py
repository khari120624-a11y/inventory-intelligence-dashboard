...
# ── Display Mode Selection & Intro ───────────────────────────────────────────
import streamlit.components.v1 as components

view_mode = st.sidebar.radio(
    "🖥️ Display Mode",
    ["🤖 3D WebGL Interactive Dashboard", "📊 Streamlit Python Analytics Suite"],
    index=0,
    help="Switch between 3D WebGL Interactive Platform and Streamlit Python Suite"
)

if view_mode == "🤖 3D WebGL Interactive Dashboard":
